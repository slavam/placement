...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="btn-group">
            <?= Html::a('<span class="glyphicon glyphicon-pencil"></span>', ['/experience/update', 'id' => $model->id], ['title' => 'Редактировать', 'class' => 'btn btn-primary']) ?>
            <?= \yii\helpers\Html::a('<span class="glyphicon glyphicon-trash"></span>', ['/experience/delete', 'id' => $model->id], [
                'title' => 'Удалить',
