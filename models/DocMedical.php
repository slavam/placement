...
/**
 * This is the model class for table "{{%doc_medical}}".
 *
 * @property integer $id
 ...
 */
class DocMedical extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['num', 'note', 'who_give', 'duration_months', 'duration_days'], 'filter', 'filter' => 'trim'],
            [['num', 'note', 'who_give', 'duration_months', 'duration_days'], 'default'],
    ...
    /**
     * Возвращает дату, по которую действует медосмотр
     * @return string
     */
    ...
    /**
     * @inheritdoc
     * @return \app\models\queries\DocMedicalQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\queries\DocMedicalQuery(get_called_class());
    }
}
