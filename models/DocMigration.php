...
/**
 * This is the model class for table "{{%doc_migration}}".
 *
 * @property integer $id
 ...
 */
class DocMigration extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['series', 'num', 'note', 'who_give', 'duration_months', 'duration_days'], 'filter', 'filter' => 'trim'],
            [['series', 'num', 'note', 'who_give', 'duration_months', 'duration_days'], 'default'],
    ...
    /**
     * Возвращает дату, по которую действует миграционная карта
     * @return string
     */
    ...
    /**
     * Возвращает серию и номер миграционной карты в виде строки
     *
     * @return string
     */
    ...
    /**
     * @inheritdoc
     * @return \app\models\queries\DocMigrationQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\queries\DocMigrationQuery(get_called_class());
    }
}
